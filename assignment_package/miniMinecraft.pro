...
HEADERS += \
#    ../../../../../../../Downloads/framebuffer/framebuffer (1)/framebuffer.h \
    src/scene/heightmap.h

SOURCES += \
#    ../../../../../../../Downloads/framebuffer/framebuffer (1)/framebuffer.cpp \
    src/scene/heightmap.cpp

DISTFILES += \
    README.txt \
    caves_water_readme.txt \
    helplog_ryan.txt \
    rivers.txt \
    textures/minecraft_textures_all_labeled.png
