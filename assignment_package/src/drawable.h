...
protected:
    ...
    int m_countT;     // The number of indices stored in bufIdxT.
    ...
    GLuint m_bufInter; //pos nor UV col
    GLuint m_bufInterT; //pos nor UV col
    GLuint m_bufIdxT; // A Vertex Buffer Object that we will use to store triangle indices (GLuints)
    ...
    bool m_interTGenerated;
    bool m_idxTGenerated; // Set to TRUE by generateIdx(), returned by bindIdx().
