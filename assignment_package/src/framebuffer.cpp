...
void FrameBuffer::setFrameBuffer(const GLuint &i) {
    m_frameBuffer = i;
}
...
void FrameBuffer::load(int texSlot = 0)
{
    mp_context->printGLErrorLog();
    ...
    mp_context->glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA,
                          m_width, m_height,
                          0, GL_BGRA, GL_UNSIGNED_INT_8_8_8_8_REV, (void*)0);
    mp_context->printGLErrorLog();
}
